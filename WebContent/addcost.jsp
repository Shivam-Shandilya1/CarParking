...
<!DOCTYPE html>
    ...
    <body>
		...
		<center>
		<table width="70%">
		<tr><th>space id</th><th>space name</th><th>total space</th><th>available</th><th>cost</th><th>update cost</th></tr>
		...
		if(rs.next()){	
			do{
				...
				out.print("<tr><th>"+rs.getString(1)+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(2)+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th><th><a href='update.jsp?id="+rs.getString(1)+"'>update</a></th></tr>");
			}while(rs.next());
		}
