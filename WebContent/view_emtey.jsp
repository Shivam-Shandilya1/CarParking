...
<%@page import="java.sql.*" %>
    ...
    <body>
		...
		<tr><th>id </th><th>Total parking</th><th>available space</th><th>cost</th><th>space name</th></tr>
		...
		if(rs.next()){	
			do{
				...
				out.print("<tr><th>"+rs.getString(1)+"</th><th>"+rs.getString(2)+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th><th>"+rs.getString(5)+"</th></tr>");
			}while(rs.next());
		}
