<!DOCTYPE html>
    ...
    <body>
		...
		<center>
			<table width="50%" height="50%"><caption>update space dealies<br><br><br></caption>
			<tr><td>space id<br><br><br></td><td><input type="number" name="sp" value="<%=request.getParameter("id")%>" readonly><br><br><br></td></tr>
			<tr><td>cost per hour <br><br><br></td><td><input type="number " name="ct"><br><br><br></td></tr>
			<tr><td><br><br><br></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="update cost of space" name="table"><br><br><br></td></tr>
			</table>
