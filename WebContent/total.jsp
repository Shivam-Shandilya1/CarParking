...
<%@page import="java.sql.*" %>
    ...
    <body>
		...
		<%!int cost=0; %>
		<table width="60%" border="2"><caption>list of empty space </caption>
		<tr><th>id </th><th>space id</th><th>cost</th><th>card number</th></tr>
		...
		if(rs.next()){	
			do{
				...
				out.print("<tr><th>"+rs.getString(1)+"</th><th>"+rs.getString(2)+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th></tr>");
				cost+=rs.getInt(3);
			}while(rs.next());
		}
		
		%>
		<tr> <td colspan="4" align="center"> total amount <%=cost %> </th></tr>
		<%cost=0; %>
		</table>
