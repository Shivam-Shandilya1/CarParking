<!DOCTYPE html>
    ...
    <body>
		...
		<center>
			<table width="50%" height="50%"><caption>add space dealies<br><br><br></caption>
			<tr><td>space name<br><br><br></td><td><input type="text "  name="sp"><br><br><br></td></tr>
			<tr><td>total parking space <br><br><br></td><td><input type="number " name="tt"><br><br><br></td></tr>
			<tr><td>cost per hour <br><br><br></td><td><input type="number " name="ct"><br><br><br></td></tr>
			<tr><td><br><br><br></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="add space" name="table"><br><br><br></td></tr>
			</table>
