                            ...
                            <ul class="grid effect-8" id="grid">
                              <li>
                                <div class="block">
                                        ...
                                        <form action="backend1.jsp">
   
		<center>
			<table width="50%"> 
			<caption>USER LOGIN <br><br> </caption>
			<tr><th></th><th><%if(request.getParameter("mes")!=null){
			out.print(request.getParameter("mes"));
			}	%></th></tr>
			
			<tr><th>EMail id<br><br></th><th><input type="email" readonly="readonly" value="<%=session.getAttribute("email") %>" name="a1"><br><br></th></tr>
			<tr><th>OTP<br><br></th><th><input type="text" name="a2" required="required"><br><br></th></tr>
			<tr><th><br><br></th><th><input type="submit" name="table" value=" LOGIN"><br><br></th></tr>
			<tr><th></th><th><a href="regiseter.jsp">Register</a></th></tr>
			</table>
