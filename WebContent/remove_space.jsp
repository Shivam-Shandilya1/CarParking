...
<!DOCTYPE html>
    ...
    <body>
		...
		<center>
		<table width="70%">
		<tr><th>id</th><th>parking id</th><th>date and time</th><th>remove parking</th></tr>
		<% Connection con=DB.getconn(); 
		
		Statement st=con.createStatement();
		
		ResultSet rs=st.executeQuery("select * from parkingdealites where email_id='"+session.getAttribute("email")+"'");
		
		if(rs.next()){	
			do{
				
				out.print("<tr><th>"+rs.getString(1)+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(4)+"</th><th><a href='remove.jsp?id="+rs.getString(1)+"'>remove parking</a></th></tr>");
			}while(rs.next());
		}
